...
if __name__ == '__main__':
    ...
    #tokenizer = Tokenizer.from_pretrained('../bert-base-japanese-whole-word-masking/')
    #tokenizer = Tokenizer.from_pretrained('cl-tohoku/bert-base-japanese-whole-word-masking')
